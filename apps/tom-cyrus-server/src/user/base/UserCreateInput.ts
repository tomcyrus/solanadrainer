...
class UserCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => PreOrderCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => PreOrderCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => PreOrderCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => CartItemCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => CartItemCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => CartItemCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
